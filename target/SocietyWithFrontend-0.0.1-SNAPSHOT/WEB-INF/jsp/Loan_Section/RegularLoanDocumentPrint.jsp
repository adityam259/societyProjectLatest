		...
		<div
			...
			<div class="content-wrapper" style="min-height: 1105.75px;">
				<section class="content-header">
					<h1 id="ContentPlaceHolder1_IdHeader">Normal Loan Document</h1>
					<ol class="breadcrumb">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label></label> <input type="submit"
												onclick="searchNormalLoanDocument();" name="btnSave" value="Search"
								...
								<div class="box-body">
									...
									<div class="col-md-4">
										...
										<div class="form-group row">
											...
											<div class="col-sm-7">
												<input name="loanMode" type="text" readonly="readonly"
													id="loanMode" class="form-control"
...
<!-- Dk/Admin/RegularLoanDocumentPrint.aspx EDB D 09:27:10 GMT -->
</html>
