         ...
         %>
			...
			<div class="content-wrapper" style="min-height: 1105.75px;">
				<section class="content-header">
					<h1 id="ContentPlaceHolder1_IdHeader">Gold Loan Application</h1>
					<ol class="breadcrumb">
				...
				<input type="hidden" name="type" value="Gold Loan Application">
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="planTerm" type="text" readonly="readonly"
														id="planTerm" class="form-control" PlaceHolder="Plan Term" /> <span id="planTermMsg"
														style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Enter
														PIN</span>
												</div>
											</div>
									...
									<div id="ContentPlaceHolder1_upcoap">
										<div class="col-md-6">
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="addressco" type="text"
...
<!-- Dk/Admin/GoldLoanApplication.aspx?Type=Application EDB D 09:27:11 GMT -->
</html>