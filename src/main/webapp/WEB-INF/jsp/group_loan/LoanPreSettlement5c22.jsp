...
<body
	...
	<form method="post" action="closeLoanRegularEMIRepaymentGroup"
									...
									<div class="col-md-4">
										<div class="form-group row">
											<label for="txtTotalPayableAmt"
												class="col-sm-5 control-label">Paid Interest<strong
												style="color: Red">*</strong></label>
											<div class="col-sm-7">
												<input name="ctl00$ContentPlaceHolder1$txtPayableInterest"
													type="text" readonly="readonly"
													id="ContentPlaceHolder1_txtPayableInterest"
													class="form-control" PlaceHolder="Paid Interest"
													onkeypress="return isNumberKey(this, event);"
													autocomplete="off" /> <span
													id="ContentPlaceHolder1_RequiredFieldValidator3"
													style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Enter
													Payable Interest</span>
											</div>
										</div>
										<div class="form-group row">
											<label for="txtTotalPayableAmt"
												class="col-sm-5 control-label">Paid Principal<strong
												style="color: Red">*</strong></label>
											<div class="col-sm-7">
												<input name="ctl00$ContentPlaceHolder1$txtPayablePrincipal"
													type="text" readonly="readonly"
													id="ContentPlaceHolder1_txtPayablePrincipal"
													class="form-control" PlaceHolder="Paid Principal" /> <span
										...
										<div class="form-group row">
											<label for="txtPayableAmount" class="col-sm-5 control-label">Total
										...
										<div class="form-group row">
											<label for="ddlDeductLateFine" class="col-sm-5 control-label">Closing
												Charge<strong style="color: Red">*</strong>
											</label>
											<div class="col-sm-4">
												<select name="ctl00$ContentPlaceHolder1$ddlclosingChrg"
													onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$ContentPlaceHolder1$ddlclosingChrg\&#39;,\&#39;\&#39;)&#39;, 0)"
													id="ContentPlaceHolder1_ddlclosingChrg"
											...
											<div class="col-sm-3">
												<input name="ctl00$ContentPlaceHolder1$txtPreClosingChages"
													type="text" value="0" readonly="readonly"
													onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$ContentPlaceHolder1$txtPreClosingChages\&#39;,\&#39;\&#39;)&#39;, 0)"
													onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;return isNumberKey(this, event);"
													id="ContentPlaceHolder1_txtPreClosingChages"
													class="form-control" />
											</div>
										</div>
									</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-7">
													<input name="ctl00$ContentPlaceHolder1$txtTotalInterestDue"
														type="text"
														onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$ContentPlaceHolder1$txtTotalInterestDue\&#39;,\&#39;\&#39;)&#39;, 0)"
														onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;return isNumberKey(this, event);"
														id="ContentPlaceHolder1_txtTotalInterestDue"
														class="form-control"
														PlaceHolder="Enter Total Interest Due" autocomplete="off" />
													<span
								...
								<div class="box-footer">
									<div class="row col-md-12">
										<input type="hidden" id="id" name="id"> <input
											...
											value="Close Loan" id="ContentPlaceHolder1_btnSave"
